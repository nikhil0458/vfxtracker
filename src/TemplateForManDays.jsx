...
import './TemplateForMandays.css';
import { ip_port } from './Configs'; 

const { Option } = Select;

const TemplateForMandays = () => {
  ...
  const handleGenerateTemplate = () => {
    ...
    const headers = ["proj", "shot", "frames", "mm", "anim", "fx", "lit", "roto", "dmp", "paint", "mgfx","unreal", "comp"];
  ...
  return (
    <Form className='form-containers' style={{margin:"40px"}}>
      <div>
        <h1 style={{ textDecoration: "underline", color: "grey", fontSize: "18px", marginBottom: "10px" }}>
          Temp for mandays
        </h1>
...
export default TemplateForMandays;
